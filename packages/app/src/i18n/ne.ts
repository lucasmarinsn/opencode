export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Fryn कागजात",
  ...
  "desktop.menu.ariaLabel": "Fryn मेनु",
  ...
  "desktop.recovery.loadFailed": "Fryn लोड हुन सकेन",
  "desktop.recovery.terminated": "Fryn विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "Fryn ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpencode": "Fryn स्थापना असफल भयो",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "Fryn अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र Fryn मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र Fryn मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू Fryn मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.server.description": "यो एप जडान भएको Fryn सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn जाँच गर्दै...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} मा Fryn जाँच गर्दै...",
  "wsl.onboarding.updatingOpencode": "अद्यावधिक गर्दै Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} मा Fryn अद्यावधिक गर्दै...",
  "wsl.onboarding.updateOpencodeIn": "अपडेट गर्नुहोस् Fryn {{distro}} मा।",
  "wsl.onboarding.updateOpencode": "अपडेट गर्नुहोस् Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}} मा तयार छ।",
  "wsl.onboarding.opencodeReady": "Fryn तयार छ।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} मा Fryn स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpencode": "Fryn स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) Fryn ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "Fryn ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि Fryn पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "Fryn डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि Fryn टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, Fryn ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "Fryn मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "settings.desktop.wsl.description": "Fryn सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "Fryn को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा Fryn कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "Fryn ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी Fryn विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "Fryn सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं Fryn को नवीनतम संस्करण चलाइरहनुभएको छ।",
