export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Fryn",
  ...
  "desktop.menu.ariaLabel": "Fryn meni",
  ...
  "desktop.recovery.loadFailed": "Fryn se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Fryn-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Fryn ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Fryn-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Fryn-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Fryn",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Fryn-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Fryn-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Fryn-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Fryn server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Fryn u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Fryn u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Fryn u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Fryn u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Fryn mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Fryn nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Fryn.",
  ...
  "help.tabs.introduction": "Fryn sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Fryn-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Fryn timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Fryn još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Fryn uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Fryn server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Fryn-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Fryn izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Fryn prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Fryn-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Fryn pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Fryn-a.",
