...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Fryn",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Fryn.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Fryn Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Fryn.",
  ...
  "prompt.placeholder.normal": 'Ask Fryn anything... "{{example}}"',
  "prompt.placeholder.simple": "Ask Fryn, attach a PDF or image, or request an action...",
  ...
  "dialog.server.description": "Switch which Fryn server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Fryn in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Fryn in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Fryn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Fryn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Fryn can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Fryn could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Fryn.",
  ...
  "help.tabs.introduction": "Fryn is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Fryn ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Fryn team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Fryn does not support MCP authentication yet.',
  ...
  "session.new.title": "What should Fryn help with today?",
  "session.new.subtitle": "Ask questions, review documents, analyze images, prepare emails, and schedule meetings from one clean workspace.",
  "session.new.card.documents.title": "Documents and PDFs",
  "session.new.card.documents.text": "Attach files and ask for summaries, checks, or clear next steps.",
  "session.new.card.images.title": "Images and screenshots",
  "session.new.card.images.text": "Send visuals and get a direct explanation of what matters.",
  "session.new.card.outlook.title": "Outlook actions",
  "session.new.card.outlook.text": "Connect Microsoft to prepare email and calendar tasks.",
  "session.new.badge.private": "Private company assistant",
  "session.new.badge.outlook": "Outlook ready",
  "session.new.badge.files": "PDF and image support",
  ...
  "sidebar.gettingStarted.line1": "Fryn includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Fryn server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Fryn",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Fryn looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Fryn follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Fryn is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Fryn launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Fryn.",
