export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Fryn has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'fryn' command.",
