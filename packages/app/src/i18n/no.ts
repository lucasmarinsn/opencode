...
export const dict = {
  ...
  "desktop.menu.documentation": "Fryn-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Fryn-meny",
  ...
  "desktop.recovery.loadFailed": "Fryn kunne ikke lastes inn",
  "desktop.recovery.terminated": "Fryn-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Fryn svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Fryn mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Fryn er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Fryn",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Fryn.",
  ...
  "dialog.server.description": "Bytt hvilken Fryn-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Fryn ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Fryn-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Fryn ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Fryn inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Fryn-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Fryn",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Fryn ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Fryn skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Fryn.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Fryn starter",
  ...
  "settings.updates.toast.latest.title": "Fryn er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Fryn.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Fryn i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Fryn i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Fryn i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Fryn i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Fryn kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Fryn kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Fryn på nytt.",
  ...
  "help.tabs.introduction": "Fryn er nå bygget rundt faner.",
  "help.tabs.sessions":
