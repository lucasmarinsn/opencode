export const dict = {
  ...
  "desktop.updater.none.message": "މިހާރުވެސް ބޭނުން ކުރަމުންދަނީ Fryn ގެ އެންމެ ފަހުގެ ވަރޝަން އެވެ",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn ގެ ވަރޝަން {{version}} ޑައުންލޯޑް ކުރެވިއްޖެ، އިންސްޓޯލްކޮށް އަލުން ލޯންޗް ކުރަން ބޭނުން ހެއްޔެވެ؟",
