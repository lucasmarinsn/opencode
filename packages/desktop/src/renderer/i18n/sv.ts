export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Fryn har laddats ned. Vill du installera den och starta om programmet?",
