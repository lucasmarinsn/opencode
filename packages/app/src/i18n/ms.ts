export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Fryn",
  ...
  "desktop.recovery.loadFailed": "Fryn gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Fryn ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Fryn tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Fryn gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Fryn selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Fryn",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Fryn.",
  ...
  "dialog.server.description": "Tukar pelayan Fryn yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Fryn dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Fryn dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Fryn dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Fryn dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Fryn boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Fryn tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Fryn.",
  ...
  "help.tabs.introduction": "Fryn kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Fryn ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Fryn",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Fryn belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Fryn dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Fryn",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Fryn pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Fryn mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Fryn.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Fryn dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Fryn.",
