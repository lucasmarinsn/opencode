export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Fryn er lastet ned. Vil du installere den og starte på nytt?",
