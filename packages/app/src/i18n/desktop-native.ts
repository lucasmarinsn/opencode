...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Fryn failed to load",
  "desktop.recovery.terminated": "Fryn window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Fryn is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Fryn installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
