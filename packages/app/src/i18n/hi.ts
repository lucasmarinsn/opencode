export const dict = {
  ...
  "desktop.menu.documentation": "Fryn दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Fryn मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Fryn लोड नहीं हो सका",
  "desktop.recovery.terminated": "Fryn विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Fryn प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Fryn इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Fryn इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Fryn अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Fryn में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Fryn में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Fryn में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Fryn सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Fryn की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Fryn अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Fryn अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Fryn को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Fryn को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Fryn तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Fryn स्थापित करें।",
  "wsl.onboarding.installOpencode": "Fryn स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Fryn द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Fryn इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Fryn को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Fryn अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Fryn टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Fryn अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Fryn में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Fryn सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Fryn के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Fryn आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Fryn सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Fryn की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Fryn लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Fryn का नवीनतम संस्करण चला रहे हैं।",
