...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn yüklenemedi",
  "desktop.recovery.terminated": "Fryn penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Fryn yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Fryn kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Fryn güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Fryn'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Fryn'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Fryn'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Fryn sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Fryn kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Fryn güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Fryn güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Fryn'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Fryn'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Fryn hazır.",
  "wsl.onboarding.opencodeReady": "Fryn hazır.",
  "wsl.onboarding.installOpencodeIn": "Fryn'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Fryn'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Fryn'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Fryn bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Fryn'u tekrar açın.",
  ...
  "help.tabs.introduction": "Fryn artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Fryn ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Fryn henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Fryn ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Fryn Masaüstü",
  ...
  "settings.desktop.wsl.description": "Fryn sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Fryn'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Fryn'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Fryn'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Fryn'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Fryn başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Fryn'un en son sürümünü kullanıyorsunuz.",
