export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Fryn",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Fryn.",
  ...
  "dialog.server.description": "Skift hvilken Fryn-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Fryn i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Fryn i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Fryn i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Fryn kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Fryn kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Fryn igen.",
  ...
  "toast.update.description": "En ny version af Fryn ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Fryn-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Fryn understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Fryn inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Fryn-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Fryn",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Fryn ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Fryn skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Fryns tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Fryn starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Fryn.",
  ...
  "desktop.recovery.loadFailed": "Fryn kunne ikke indlæses",
  "desktop.recovery.terminated": "Fryn-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Fryn mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Fryn er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Fryn er nu bygget op omkring faner.",
  "help.tabs.sessions":
