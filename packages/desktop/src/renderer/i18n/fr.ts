export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Fryn a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
