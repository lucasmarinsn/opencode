export const dict = {
  ...
  "desktop.recovery.loadFailed": "Frynを読み込めませんでした",
  "desktop.recovery.terminated": "Frynのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Frynが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Frynのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはFrynがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Frynのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Frynが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Frynで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してFrynで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Frynで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するFrynサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Frynを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のFrynを確認中...",
  "wsl.onboarding.updatingOpencode": "Frynを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のFrynを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のFrynを更新してください。",
  "wsl.onboarding.updateOpencode": "Frynを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のFrynの準備ができました。",
  "wsl.onboarding.opencodeReady": "Frynの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にFrynをインストールしてください。",
  "wsl.onboarding.installOpencode": "Frynをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Frynがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "FrynでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Frynをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Frynでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Frynの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをFrynチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: FrynはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Frynには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でFrynサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Frynの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのFrynの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Frynがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Frynのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Fryn の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Fryn は最新バージョンです。",
