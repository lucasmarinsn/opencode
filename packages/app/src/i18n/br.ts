export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Fryn",
  ...
  "desktop.menu.ariaLabel": "Menu do Fryn",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Fryn",
  "desktop.recovery.terminated": "A janela do Fryn foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Fryn não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Fryn",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Fryn não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Fryn foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Fryn",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Fryn.",
  ...
  "prompt.placeholder.normal": 'Pergunte ao Fryn... "{{example}}"',
  "prompt.placeholder.simple": "Pergunte ao Fryn, envie um PDF ou imagem, ou peça uma ação...",
  ...
  "dialog.server.description": "Trocar para qual servidor Fryn este aplicativo se conecta.",
  ...
  "wsl.onboarding.step.opencode": "Fryn",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Fryn em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Fryn em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Fryn em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Fryn",
  "wsl.onboarding.opencodeReadyIn": "O Fryn está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Fryn está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Fryn em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Fryn possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Fryn não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Fryn novamente.",
  ...
  "help.tabs.introduction": "Agora, o Fryn é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Fryn ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Fryn",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Fryn ainda não suporta autenticação MCP.',
  ...
  "session.new.title": "Como o Fryn pode ajudar hoje?",
  "session.new.subtitle":
    "Faça perguntas, analise documentos, entenda imagens, prepare e-mails e organize reuniões em um só lugar.",
  "session.new.card.documents.title": "Documentos e PDFs",
  "session.new.card.documents.text": "Anexe arquivos e peça resumos, revisões ou próximos passos claros.",
  "session.new.card.images.title": "Imagens e prints",
  "session.new.card.images.text": "Envie imagens e receba uma explicação direta do que importa.",
  "session.new.card.outlook.title": "Ações no Outlook",
  "session.new.card.outlook.text": "Conecte a Microsoft para preparar e-mails e tarefas de agenda.",
  "session.new.badge.private": "Assistente privado da empresa",
  "session.new.badge.outlook": "Outlook integrado",
  "session.new.badge.files": "PDF e imagem",
  ...
  "sidebar.gettingStarted.line1": "Fryn inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Fryn dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Fryn",
  ...
  "settings.general.row.appearance.description": "Personalize como o Fryn aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Fryn segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Fryn é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Fryn iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Fryn.",
