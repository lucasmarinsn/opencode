export const dict = {
  ...
  "desktop.menu.documentation": "Fryn Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Fryn μενού",
  ...
  "desktop.recovery.loadFailed": "Fryn απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Fryn το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Fryn δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Fryn η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Fryn",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Fryn.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Fryn συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Fryn σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Fryn σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Fryn σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Fryn στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Fryn να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Fryn δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Fryn.",
  ...
  "help.tabs.introduction": "Fryn Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Fryn ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Fryn",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Fryn δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Fryn Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Fryn μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Fryn",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Fryn στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Fryn ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Fryn.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Fryn",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Fryn.",
