...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Fryn",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Fryn zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Fryn zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Fryn zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Fryn-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Fryn in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Fryn wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Fryn in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Fryn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Fryn aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Fryn ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Fryn ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Fryn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Fryn installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Fryn einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Fryn konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Fryn erneut.",
  ...
  "toast.update.description": "Eine neue Version von Fryn ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Fryn-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Fryn unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Fryn mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Fryn enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Fryn-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Fryn ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Fryn auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Fryn dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Fryn anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Fryn automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Fryn ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Fryn wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Fryn konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Fryn-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Fryn reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Fryn-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Fryn-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Fryn basiert jetzt auf Tabs.",
  "help.tabs.sessions":
