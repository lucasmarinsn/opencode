export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của Fryn đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
