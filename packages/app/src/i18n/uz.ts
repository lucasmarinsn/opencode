export const dict = {
  ...
  "desktop.menu.documentation": "Fryn hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Fryn menyusi",
  ...
  "desktop.recovery.loadFailed": "Fryn yuklanmadi",
  "desktop.recovery.terminated": "Fryn oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Fryn javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Fryn oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Fryn yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Fryn’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Fryn da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Fryn da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Fryn serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Fryn {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Fryn yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Fryn {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Fryn-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Fryn-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Fryn tayyor.",
  "wsl.onboarding.installOpencodeIn": "Fryn-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Fryn-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Fryn WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Fryn WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Fryn-ni qayta oching.",
  ...
  "help.tabs.introduction": "Fryn endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Fryn jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Fryn hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Fryn bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Fryn serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Fryn uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Fryn qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Fryn tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Fryn mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Fryn ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Fryn oxirgi versiyasini ishga tushiryapsiz.",
