export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Frynn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Frynssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Frynssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Frynssa.",
  ...
  "dialog.server.description": "Vaihda Fryn-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Fryna...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Fryna kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Fryna...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Fryna kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Fryn jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Fryn jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryna ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Fryn voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Fryn ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Fryn uudelleen.",
  ...
  "toast.update.description": "Frynn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Fryn-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Fryn ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Fryn sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Fryn-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Frynn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Fryn näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Fryn järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Frynn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Fryn käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Frynn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Fryn-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Fryn-valikko",
  ...
  "desktop.recovery.loadFailed": "Frynn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Fryn-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Fryn ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Frynn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryna ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Frynn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Fryn perustuu nyt välilehtiin.",
  "help.tabs.sessions":
