export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Fryn.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Fryn er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
