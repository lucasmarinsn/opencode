export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn kunde inte läsas in",
  "desktop.recovery.terminated": "Fryn-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Fryn svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Fryn misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Fryn",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Fryn.",
  ...
  "dialog.server.description": "Växla vilken Fryn-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Fryn i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Fryn i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Fryn i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Fryn i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Fryn kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Fryn kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Fryn igen.",
  ...
  "help.tabs.introduction": "Fryn är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Fryn ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Fryn-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Fryn stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Fryn innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Fryn-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Fryn",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Fryn ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Fryn följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Fryns tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Fryn startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Fryn.",
