# Fryn Backend - MiMo-V2.5 Free

Gateway privado do Fryn para ate 12 instalacoes. A chave real permanece no Railway e o aplicativo mostra apenas **Fryn AI**.

## Modelo

O unico modelo e `mimo-v2.5-free`, servido pelo OpenCode Zen em endpoint compativel com OpenAI. Os IDs antigos dos modos continuam aceitos temporariamente, mas todos usam exatamente esse mesmo modelo. Nao existe fallback pago ou troca silenciosa de provedor.
...
4. Faca o deploy e confirme que `/health` retorna `ok: true`, `opencode-zen-mimo-v2.5-free` e somente `assistant` em `routing.models`.
...
Segundo a documentacao do OpenCode Zen, o MiMo-V2.5 Free e gratuito por tempo limitado e, durante o periodo gratuito, dados podem ser usados para melhoria do modelo. Nao envie codigo, documentos ou dados confidenciais da empresa nessa modalidade.
