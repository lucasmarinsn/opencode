export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Fryn е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
