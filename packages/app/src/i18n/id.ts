export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn gagal dimuat",
  "desktop.recovery.terminated": "Jendela Fryn berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Fryn tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Fryn gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Fryn selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Fryn",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Fryn.",
  ...
  "dialog.server.description": "Ganti server Fryn mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Fryn di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Fryn di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Fryn di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Fryn di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Fryn dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Fryn tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Fryn.",
  ...
  "help.tabs.introduction": "Fryn kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Fryn ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Fryn",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Fryn belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Fryn di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Fryn",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Fryn di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Fryn mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Fryn diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Fryn.",
