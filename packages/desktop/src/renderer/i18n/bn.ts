export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "আপনি ইতিমধ্যেই Fryn এর সর্বশেষ সংস্করণ ব্যবহার করছেন৷",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn-এর {{version}} সংস্করণ ডাউনলোড করা হয়েছে, আপনি কি এটি ইনস্টল করে পুনরায় চালু করতে চান?",
