export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "तपाईंले पहिले नै Fryn को नवीनतम संस्करण प्रयोग गरिरहनुभएको छ",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn को संस्करण {{version}} डाउनलोड गरिएको छ, के तपाइँ यसलाई स्थापना गरेर पुन: लन्च गर्न चाहनुहुन्छ?",
