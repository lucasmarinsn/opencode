export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Fryn telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
