export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Fryn aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Fryn ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Fryn installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Fryn",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Fryn'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Fryn.",
  ...
  "dialog.server.description": "Lülitage, millise Fryn serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Fryn kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Fryn värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Fryn värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Fryn jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Fryn asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Fryn saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Fryn ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Fryn.",
  ...
  "help.tabs.introduction": "Fryn Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Fryn ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Fryn meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Fryn ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Fryn sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage Fryn server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Fryn kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Fryn teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Fryn järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Fryn on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Fryn käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Fryn uusimat versiooni.",
