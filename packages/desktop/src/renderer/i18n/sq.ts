export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Fryn është shkarkuar, dëshironi ta instaloni dhe rinisni?",
