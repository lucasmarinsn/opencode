export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Fryn versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
