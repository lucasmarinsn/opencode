export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
