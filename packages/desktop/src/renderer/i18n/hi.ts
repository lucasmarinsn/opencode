export const dict = {
  ...
  "desktop.updater.none.message": "आप पहले से ही Fryn का नवीनतम संस्करण उपयोग कर रहे हैं",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn का संस्करण {{version}} डाउनलोड हो गया है। क्या आप इसे इंस्टॉल करके ऐप को फिर से खोलना चाहेंगे?",
