...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn 載入失敗",
  "desktop.recovery.terminated": "Fryn 視窗意外終止",
  "desktop.recovery.unresponsive": "Fryn 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Fryn 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Fryn",
  "desktop.wsl.error.updateVersion":
    "Fryn 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Fryn 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Fryn Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Fryn 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Fryn 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Fryn 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Fryn...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Fryn 已就緒。",
  "wsl.onboarding.opencodeReady": "Fryn 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Fryn。",
  "wsl.onboarding.installOpencode": "安裝 Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Fryn",
  ...
  "wsl.onboarding.wslUnavailable.description": "Fryn 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Fryn。",
  ...
  "help.tabs.introduction": "Fryn 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Fryn 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Fryn 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Fryn 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Fryn 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Fryn 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Fryn 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Fryn 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Fryn 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Fryn 啟動時自動檢查更新",
