export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Fryn. Chcete ji nainstalovat a aplikaci znovu spustit?",
