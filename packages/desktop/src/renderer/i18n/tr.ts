export const dict = {
  ...
  "desktop.updater.none.message": "Fryn'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
