export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Fryn. ¿Quieres instalarla y reiniciar?",
