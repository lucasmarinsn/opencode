export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Fryn is gedownload. Wil je deze installeren en Fryn opnieuw starten?",
