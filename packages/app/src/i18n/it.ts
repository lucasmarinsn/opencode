export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Fryn",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Fryn.",
  ...
  "dialog.server.description": "Cambia il server Fryn a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Fryn in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Fryn in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Fryn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Fryn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Fryn possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Fryn non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Fryn.",
  ...
  "help.tabs.introduction": "Fryn ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Fryn ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Fryn",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Fryn non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Fryn all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Fryn",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Fryn sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Fryn segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Fryn.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Fryn",
  ...
  "settings.updates.toast.latest.title": "Fryn è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Fryn.",
  ...
  "desktop.menu.documentation": "Documentazione di Fryn",
  ...
  "desktop.menu.ariaLabel": "Menu Fryn",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Fryn",
  "desktop.recovery.terminated": "La finestra di Fryn si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Fryn non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Fryn non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Fryn è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
