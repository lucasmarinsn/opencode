export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Fryn. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
