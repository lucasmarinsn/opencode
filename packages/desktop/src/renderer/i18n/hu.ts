export const dict = {
  ...
  "desktop.updater.none.message": "Már az Fryn legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Fryn {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
