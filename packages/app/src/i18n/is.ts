...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Fryn",
  "Fryn-glugganum var óvænt lokað",
  "Fryn svarar ekki",
  ...
  "Fryn er ekki uppsett í {{distro}}",
  "Uppfærslu Fryn lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Fryn",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Fryn.",
  ...
  "dialog.server.description": "Skiptu um hvaða Fryn miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Fryn í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Fryn í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Fryn í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Fryn í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Fryn getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Fryn gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Fryn aftur.",
  ...
  "help.tabs.introduction": "Fryn er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Fryn ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Fryn teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Fryn styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Fryn inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Fryn skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Fryn netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Fryn",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Fryn lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Fryn fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Fryn er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Fryn ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Fryn.",
