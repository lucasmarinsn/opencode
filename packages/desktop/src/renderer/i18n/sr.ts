export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Fryn је преузета, да ли желите да је инсталирате и поново покренете?",
