export const dict = {
  ...
  "desktop.menu.documentation": "Fryn Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Fryn",
  ...
  "desktop.recovery.loadFailed": "Fryn se nepodařilo načíst",
  "desktop.recovery.terminated": "Fryn okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Fryn nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Fryn instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Fryn.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Fryn serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Fryn v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Fryn v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Fryn v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Fryn do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Fryn může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Fryn nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Fryn.",
  ...
  "help.tabs.introduction": "Fryn Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Fryn ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Fryn",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Fryn zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Fryn uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Fryn",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Fryn na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Fryn následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Fryn.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Fryn",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Fryn.",
