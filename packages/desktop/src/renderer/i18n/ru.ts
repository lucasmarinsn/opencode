export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Fryn",
  ...
  "desktop.updater.downloaded.prompt": "Версия Fryn {{version}} загружена. Хотите установить и перезапустить?",
