...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Fryn se nije uspio učitati",
  "Prozor aplikacije Fryn neočekivano je zatvoren",
  "Fryn ne reagira",
  ...
  "Instalacija aplikacije Fryn nije uspjela",
  ...
  "Fryn nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Fryn je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Fryn",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Fryn.",
  ...
  "dialog.server.description": "Promijenite na koji se Fryn poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Fryn u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Fryn u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Fryn u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Fryn u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Fryn",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Fryn može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Fryn nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Fryn.",
  ...
  "help.tabs.introduction": "Radna površina Fryn sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Fryn ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Fryn timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Fryn još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Fryn uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Fryn Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Fryn poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Fryn",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Fryn izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Fryn slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Fryn tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Fryn pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Fryn.",
