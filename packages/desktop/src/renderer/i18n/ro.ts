export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Fryn a fost descărcată. Vrei să o instalezi și să repornești?",
