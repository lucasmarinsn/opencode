export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Fryn wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
