export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Fryn-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Fryn-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
