export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه Fryn استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} Fryn دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
