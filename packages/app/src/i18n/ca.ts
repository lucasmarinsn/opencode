export const dict = {
  ...
  "desktop.menu.documentation": "Fryn Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Fryn.",
  ...
  "desktop.recovery.loadFailed": "Fryn no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Fryn s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Fryn no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Fryn ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Fryn",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Fryn.",
  ...
  "dialog.server.description": "Canvia a quin Fryn servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Fryn a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Fryn a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Fryn a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Fryn a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Fryn pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Fryn no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Fryn.",
  ...
  "help.tabs.introduction": "Fryn L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Fryn ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Fryn.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Fryn encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Fryn Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Fryn dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Fryn",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Fryn al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Fryn segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Fryn.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Fryn.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Fryn.",
