export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Fryn",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Fryn",
  "desktop.recovery.terminated": "Okno Fryn zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Fryn nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Fryn",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Fryn została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Fryn",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Fryn.",
  ...
  "dialog.server.description": "Przełącz serwer Fryn, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Fryn w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Fryn w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Fryn w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Fryn w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Fryn będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Fryn nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Fryn.",
  ...
  "help.tabs.introduction": "Fryn korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Fryn ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Fryn",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Fryn nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Fryn zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Fryn wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Fryn",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Fryn na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Fryn ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Fryn.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Fryn",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Fryn.",
