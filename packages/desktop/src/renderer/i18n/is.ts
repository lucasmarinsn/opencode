export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Fryn hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
