export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Έχει γίνει λήψη της έκδοσης {{version}} του Fryn. Θέλετε να την εγκαταστήσετε και να επανεκκινήσετε την εφαρμογή;",
