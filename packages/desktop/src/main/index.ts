...
const APP_IDS: Record<string, string> = {
  dev: "com.fryn.desktop",
  beta: "com.fryn.desktop",
  prod: "com.fryn.desktop",
}
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "com.fryn.desktop"
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("fryn://"))
    if (urls.length) {
  ...
  shellEnv = yield* Effect.promise(() => preferAppEnv(app.getPath("userData")))
  ...
  app.setAsDefaultProtocolClient("fryn")
  registerRendererProtocol()
  setDockIcon()
