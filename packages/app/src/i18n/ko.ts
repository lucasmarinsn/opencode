export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Fryn에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Fryn에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Fryn에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Fryn 서버를 전환합니다.",
  ...
  "toast.update.description": "Fryn의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Fryn 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Fryn는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Fryn에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Fryn 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Fryn 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Fryn가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Fryn가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Fryn 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Fryn를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Fryn를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Fryn 확인 중...",
  "wsl.onboarding.updatingOpencode": "Fryn 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Fryn 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Fryn를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Fryn 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Fryn를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Fryn가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Fryn를 설치하세요.",
  "wsl.onboarding.installOpencode": "Fryn 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Fryn에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Fryn에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Fryn를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Fryn은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Fryn를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Fryn 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Fryn가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Fryn 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Fryn가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Fryn 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
