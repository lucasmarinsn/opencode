export const dict = {
  ...
  "desktop.menu.documentation": "Fryn Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Fryn ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Fryn se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Fryn se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Fryn ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Fryn je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Fryn",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Fryn.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Fryn se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Fryn ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Fryn v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Fryn ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Fryn v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Fryn v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Fryn v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Fryn doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Fryn ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Fryn.",
  ...
  "help.tabs.introduction": "Fryn je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Fryn ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Fryn",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Fryn še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Fryn znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Fryn",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Fryn izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Fryn sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Fryn.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Fryn",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Fryn.",
