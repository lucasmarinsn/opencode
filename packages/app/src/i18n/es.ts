export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Fryn",
  ...
  "desktop.menu.ariaLabel": "Menú de Fryn",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Fryn",
  "desktop.recovery.terminated": "La ventana de Fryn se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Fryn no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Fryn",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Fryn finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Fryn",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Fryn.",
  ...
  "dialog.server.description": "Cambiar el servidor de Fryn al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Fryn en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Fryn en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Fryn en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Fryn en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Fryn pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Fryn no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Fryn.",
  ...
  "help.tabs.introduction": "Fryn ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Fryn ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Fryn",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Fryn aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Fryn incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Fryn dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Fryn",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Fryn en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Fryn sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Fryn.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Fryn",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Fryn.",
