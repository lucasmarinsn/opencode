export const dict = {
  ...
  "desktop.menu.documentation": "Fryn دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Fryn مینو",
  ...
  "desktop.recovery.loadFailed": "Fryn لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Fryn ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Fryn جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Fryn کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Fryn انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Fryn کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Fryn میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Fryn میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Fryn میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Fryn سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Fryn چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Fryn کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Fryn کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Fryn کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Fryn کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Fryn تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Fryn انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Fryn انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Fryn WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Fryn اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Fryn کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Fryn اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Fryn ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Fryn ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Fryn میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Fryn ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Fryn سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Fryn کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Fryn کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Fryn سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Fryn کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Fryn لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Fryn کا تازہ ترین ورژن چلا رہے ہیں۔",
