export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Fryn er blevet downloadet. Vil du installere den og genstarte?",
