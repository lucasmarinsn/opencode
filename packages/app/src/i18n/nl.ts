export const dict = {
  ...
  "desktop.menu.documentation": "Fryn-documentatie",
  ...
  "desktop.recovery.loadFailed": "Fryn kan niet worden geladen",
  "desktop.recovery.terminated": "Het Fryn-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Fryn reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Fryn is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Fryn-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Fryn",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Fryn te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Fryn te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Fryn te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Fryn-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Fryn controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Fryn bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Fryn bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Fryn bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Fryn bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Fryn is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Fryn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Fryn een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Fryn kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Fryn opnieuw.",
  ...
  "help.tabs.introduction": "Fryn is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Fryn ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Fryn-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Fryn ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Fryn bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Fryn-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Fryn",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Fryn eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Fryn het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Fryn aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Fryn wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Fryn is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Fryn.",
