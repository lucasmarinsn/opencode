export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Fryn",
  "desktop.recovery.terminated": "توقفت نافذة Fryn بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Fryn لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Fryn",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Fryn، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Fryn",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Fryn Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Fryn.",
  ...
  "dialog.server.description": "تبديل خادم Fryn الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Fryn في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Fryn في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Fryn في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Fryn في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Fryn من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Fryn التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Fryn.",
  ...
  "help.tabs.introduction": "أصبح Fryn الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Fryn ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Fryn",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Fryn لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Fryn نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Fryn داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Fryn",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Fryn على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Fryn يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Fryn.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Fryn",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Fryn.",
