export const dict = {
  ...
  "desktop.menu.documentation": "Fryn Skjøl",
  ...
  "desktop.menu.ariaLabel": "Fryn valmynd",
  ...
  "desktop.recovery.loadFailed": "Fryn miseydnaðist at heinta",
  "desktop.recovery.terminated": "Fryn vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Fryn svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Fryn uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Fryn dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Fryn",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Fryn.",
  ...
  "dialog.server.description": "Skift hvønn Fryn ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Fryn í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Fryn í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Fryn í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Fryn upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Fryn kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Fryn kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Fryn aftur.",
  ...
  "help.tabs.introduction": "Fryn Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Fryn ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Fryn toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Fryn stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Fryn inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Fryn Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Fryn ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Fryn",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Fryn sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Fryn fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Fryn er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Fryn byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Fryn.",
