export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Fryn ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Fryn মেনু",
  ...
  "desktop.recovery.loadFailed": "Fryn লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Fryn উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Fryn সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Fryn ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Fryn আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Fryn দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Fryn-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Fryn-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Fryn-এ ব্যবহার করুন৷",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Fryn সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Fryn চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Fryn আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Fryn আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "Fryn আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "Fryn প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Fryn ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Fryn ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Fryn একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Fryn এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Fryn আবার খুলুন।",
  ...
  "help.tabs.introduction": "Fryn ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Fryn টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Fryn এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "Fryn বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Fryn সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Fryn-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Fryn কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Fryn সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Fryn থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Fryn চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Fryn এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
