export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Fryn uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
