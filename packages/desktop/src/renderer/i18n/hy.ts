export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Fryn-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Fryn-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
