export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Fryn",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Fryn",
  "desktop.recovery.terminated": "La fenêtre Fryn s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Fryn ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Fryn",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Fryn est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Fryn",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Fryn.",
  ...
  "dialog.server.description": "Changez le serveur Fryn auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Fryn dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Fryn dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Fryn dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Fryn dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Fryn puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Fryn n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Fryn.",
  ...
  "help.tabs.introduction": "Fryn s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Fryn ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Fryn",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Fryn ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Fryn inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Fryn dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Fryn",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Fryn sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Fryn suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Fryn.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Fryn",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Fryn.",
