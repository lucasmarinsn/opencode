...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Fryn įkelti nepavyko",
  "Fryn langas netikėtai užsidarė",
  "Fryn neatsako",
  ...
  "Fryn įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Fryn neįdiegtas distributyve {{distro}}",
  "Fryn naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Fryn modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Fryn.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Fryn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Fryn.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Fryn serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Fryn...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Fryn {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Fryn...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Fryn {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Fryn {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Fryn",
  "wsl.onboarding.opencodeReadyIn": "Fryn yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Fryn yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Fryn į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Fryn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Fryn galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Fryn nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Fryn.",
  ...
  "help.tabs.introduction": "Fryn dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Fryn ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Fryn komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Fryn dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Fryn apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Fryn darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Fryn serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Fryn ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Fryn atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Fryn seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Fryn temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Fryn",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Fryn versiją.",
