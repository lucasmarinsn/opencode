export const dict = {
  ...
  "desktop.recovery.loadFailed": "Fryn yüklənə bilmədi",
  "desktop.recovery.terminated": "Fryn pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Fryn cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Fryn quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Fryn {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Fryn yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Fryn tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Fryn-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Fryn Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Fryn-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Fryn-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Fryn serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Fryn yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Fryn yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Fryn yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Fryn yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Fryn-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Fryn-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Fryn {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Fryn hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Fryn-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Fryn quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Fryn quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Fryn WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Fryn bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Fryn-u yenidən açın.",
  ...
  "help.tabs.introduction": "Fryn indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Fryn-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Fryn komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Fryn hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Fryn-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Fryn serverini işlət.",
  ...
  "settings.general.row.language.description": "Fryn üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Fryn-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Fryn-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Fryn-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Fryn açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Fryn-un ən son versiyasından istifadə edirsiniz.",
