export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Fryn",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Fryn è stata scaricata. Vuoi installarla e riavviare l'app?",
